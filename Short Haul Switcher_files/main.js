geotab.addin.shortHaulSwitcher = function(api, state) {
			...
			var storingInfoLocalStorage = function(state) {
				...
				shortHaulCache.push({date:dateStamp,device:{id:deviceId}});
 ...
 */						 
			...
			var previousDutyStatusLog = function(){
				//alert("Previous status")
					api.call("Get", {"typeName":"DutyStatusLog",
							"search":{
							"userSearch":{"id":activeUser.id},
				...
				var addOnDutyLog = function(){
					//alert("Adding Status")
				api.call("Add",{ typeName: "DutyStatusLog",
								entity: {
									"driver": {
										"id": activeUser.id
									},
			...
			var calls = [];
					...
					previousDutyStatusLog();
						...
						calls.push(["Set", {typeName: "User", entity: activeUser}])
